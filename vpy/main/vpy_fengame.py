...
class Env(object):
    ...
    def __init__(self):
        ...
        self.base_plane = box(pos=vector(0, 0, 0), size=vector(25, 0.01, 25), color=color.gray(0.5))
    ...
    def camera_follow(self, target: sphere):
        try:
            self.scene.camera.center = target.pos
        except:
            pass
...
class Phys_plane(object):
    def __init__(self, x, y, z, size: vector):
        pass
...
if __name__ == '__main__':
    ...
    main()
    end_time = time()
    print('\ntime :{:f} ms'.format((end_time - start_time)*1000))
# ==================================================